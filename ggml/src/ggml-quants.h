...
GGML_API void quantize_row_dashq_2_ref(const float * GGML_RESTRICT x, block_dashq_2 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_dashq_3_ref(const float * GGML_RESTRICT x, block_dashq_3 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_dashq_2(const block_dashq_2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_dashq_3(const block_dashq_3 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_dashq_2(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_dashq_3(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
